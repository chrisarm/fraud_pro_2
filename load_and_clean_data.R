...
cdt[, i.merchnum := NULL] #remove fill column
...
### Find most common merch_zip based on merch_description match to fill in missing values
...
cdt[, i.merch_zip := NULL] #remove leftover field
